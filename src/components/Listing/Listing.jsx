      ...
      <div className={`container ${styles["sidebar-contentRight-container"]}`}>
        ...
        <div className={`${styles["content-right-container"]} container mt-3`}>
          <div className={`${styles["header-content-right"]}`}>
            <Button
              onClick={() => handleGridSelector("1x1")}
              className={`${grid === "1x1" ? styles["activeGrid"] : ""}`}
            >
              <IoMdMenu />
            </Button>
            <Button
              onClick={() => handleGridSelector("3x3")}
              className={`${grid === "3x3" ? styles["activeGrid"] : ""}`}
            >
              <BsFillGrid3X3GapFill />
            </Button>
            <Button
              onClick={() => handleGridSelector("4x4")}
              className={`${grid === "4x4" ? styles["activeGrid"] : ""}`}
            >
              <TfiLayoutGrid4Alt style={{ fontSize: "2rem" }} />
            </Button>
          ...
          <div
            className={`${styles["all-content-right-product"]} ${
              styles[`grid-${grid}`]
            }`}
          >
            {products.length > 0 ? (
